...
{!isEmailSent && 
      ...
      <form onSubmit={onSubmitEmail} className="bg-slate-900 p-8 rounded-lg shadow-lg w-96 text-sm">
        ...
        <button className="w-full py-2.5 bg-gradient-to-r cursor-pointer from-indigo-500 to-indigo-900 text-white rounded-full mt-3">
...
{!isOtpSubmited && isEmailSent &&
      ...
      >
        ...
        <button className="w-full py-2.5 text-white cursor-pointer rounded bg-gradient-to-r from-indigo-500 to-indigo-900">
         Submit 
        </button>
      </form>
}
...
{isOtpSubmited && isEmailSent &&
      ...
      className="bg-slate-900 p-8 rounded-lg shadow-lg w-96 text-sm">
        ...
        <div className="mb-4 items-center gap-3 flex w-full px-5 py-2.5 rounded-full bg-[#333A5C]">
